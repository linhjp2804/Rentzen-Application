...
<div class="row">
    <div class="col-md-3">
        <img class='img-fluid rounded' src='<?php echo $app_view['picture_url'];?>' alt='home' style='max-width: 100%'>
    </div>
    <div class="col-md-9">
        <div class="row">
            <div class="col-md-3">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <a class="btn btn-default btn-block" href='<?php echo $base_path;?>/rental_applications?pending'>Back to Pending Applications</a>
        </div>
